...
import { ConditionalNavbar } from "@/components/storefront/ConditionalNavbar";
...
export default async function StorefrontLayout({
  ...
  return (
    <>
      <Preloader text={settings["site.preloader_text"] || "URBAN MOBİLYA"} />
      <CustomCursor />
      <SmoothScrollProvider>
        <ConditionalNavbar
          brand={settings["site.brand"] || "URBAN MOBİLYA"}
          links={navLinks}
